...
def landing_sections_html(props):
    ...
    return "\n".join([
        ...
        '.lc-proof { color: rgba(255,255,255,0.92); font-weight: 600; font-size: 14.5px; letter-spacing: 0.4px; margin: -4px 0 20px; }',
        '.lc-proof .star { color: var(--gold); }',
        ...
        '<p class="lc-proof"><span class="star">&#9733;&#9733;&#9733;&#9733;&#9733;</span> 950 five-star reviews across Airbnb and VRBO &middot; Airbnb Superhost &middot; VRBO Premier Host</p>',
        '<p>MVP Rentals &mdash; My Vacation Property Rentals &mdash; are six vacation homes in Albrightsville, PA, located in a lake community in the heart of the Poconos just minutes from Jim Thorpe, Lake Harmony, ski slopes, water parks, whitewater rafting, casinos, Pocono Raceway, and the state parks &mdash; Hickory Run, Beltzville, and Lehigh Gorge &mdash; with miles of hiking and biking trails and more. You will have access to the amenities located within the community including the sandy beach at the lake, community outdoor pool, pickleball, basketball, volleyball, and tennis courts. Every home is pet friendly &mdash; dogs warmly welcome &mdash; and 5 of 6 have fully fenced back yards. Book direct with the owner &mdash; no service fees, no middleman.</p>',
        '<h2>The Six Homes</h2>',
        '<div class="home-cards">',
    ] + cards + [
        '</div>',
        '<h2>Why Book Direct?</h2>',
        '<p>Booking here is booking with Will, the owner &mdash; the same person who sends your door code and answers your texts during your stay. Same homes and same calendar as the big platforms, but with no service fee added: the price you see is the price. Pay by Venmo, Zelle, or check; your reservation is confirmed as soon as payment is received. These are true Pocono rentals by owner &mdash; you deal with the owner from first question to checkout.</p>',
        '</div>',
        '</section>',
        LANDING_END,
    ])
