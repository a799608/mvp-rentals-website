...
def landing_sections_html(props):
    ...
    return "\n".join([
        ...
        '<p>MVP Rentals &mdash; My Vacation Property Rentals &mdash; are six pet-friendly vacation homes in Albrightsville, PA, in a lake community in the heart of the Poconos. Minutes away: Jim Thorpe, ski slopes, water parks, whitewater rafting, and miles of hiking and biking trails. Every stay includes access to the community&rsquo;s amenities &mdash; the sandy beach on the lake, the outdoor pool, and courts for pickleball, basketball, volleyball, and tennis. Every home is pet friendly, and five of the six have fully fenced backyards. Book direct with the owner: no service fees, no middleman. Pick your dates above and find the MVP of your next group trip.</p>',
        '<h2>The Six Homes</h2>',
